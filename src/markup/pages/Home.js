    ...
    <div className="page-wrapper">
      ...
      <section className="video-section">
        <div
          data-parallax='{"y": 50}'
          className="sec-bg"
          style={{ backgroundImage: "url(/custom/banner/banner1.jpg)" }}
        ></div>
          ...
          <div className="row">
            <div className="col-lg-5">
              <div className="image-box">
                <img src="/custom/misc/vban1.jpg" alt="" />
                <img src="/custom/misc/vban2.jpg" alt="" />
      ...
      <section className="features-section">
        <div className="auto-container">
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="image">
                <img src="/custom/misc/dashboard.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="col-lg-6">
              ...
              <div className="row">
                <div className="col-md-5">
                  <div className="image">
                    <img src="/custom/misc/old-car-front.jpg" alt="" />
                  </div>
                </div>
